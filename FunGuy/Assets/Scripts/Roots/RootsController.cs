...
{
    // TODO: Rename!
    public class RootsController: IEventReceiver<StartRootingEvent>, IEventReceiver<StopRootingEvent>, IGameSingleton
    {
        /**
        ...
        private static readonly Lazy<RootsController> _instance = new(() => new RootsController());
        public static RootsController INSTANCE => _instance.Value;
